/*
* Flappy Bert - From Sesame Street
* Special Thanks to Hyspace's (https://github.com/hyspace/flappy) and Uralozden's (https://github.com/uralozden/flappy-bird)
* GitHub repos for making this possible
* 
* Built on top of the Phaser Game JS Framework (https://github.com/photonstorm/phaser)
*/
...
parent = document.querySelector("#bert");
...
main = function() {
  ...
  fallsounds = function (sounds) {
    var sounds = ["assets/sounds/bert-ernie2.mp3", "assets/sounds/bert-ernie.mp3"];
  ...
  if (myAudio.canPlayType('audio/ogg')) {
    assets = {
      spritesheet: {
        bird: ["assets/images/bert-hands.png", 30, 76]
      },
      image: {
        tubeTop: ["assets/images/tubeUP.png"],
        tubeBottom: ["assets/images/tubeDOWN.png"],
        ground: ["assets/images/pavement.png"],
        streetSign: ["assets/images/street-sign.png"],
        bg: ["assets/images/bg.png"]
      },
      audio: {
          flap: ["assets/sounds/wing.ogg"],
          laugh: ["assets/sounds/bert-laugh.ogg"],
          fall: ["assets/sounds/bert-ernie.ogg"],
      ...
      assets = {
        ...
        audio: {
          flap: ["assets/sounds/wing.mp3"],
          laugh: ["assets/sounds/bert-laugh.mp3"],
          fall: ["assets/sounds/bert-ernie.mp3"],
  ...
  reset = function() {
    ...
    gameOver = false;
    score = 0;
    streetSign = game.add.tileSprite(90, 30, 100, 35, 'streetSign');
    scoreText.setText("Flappy Bert");
    instText.setText("Touch or Tap to Start");
...
/*  wf.src = ('https:' === document.location.protocol ? 'https' : 'http') + '://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js'; */
  wf.src = ('https:' === document.location.protocol ? 'https' : 'http') + '://127.0.0.1/Flappy_Bert_Game/webfont.js';
